...
class DisLikedPostsPage extends StatefulWidget {
  const DisLikedPostsPage({super.key});

  @override
  State<DisLikedPostsPage> createState() => _DisLikedPostsPageState();
}

class _DisLikedPostsPageState extends State<DisLikedPostsPage> {
  ...
  void initState() {
    ...
    controller = Get.put(GetActivitiesController(type: 'disliked'));
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Posts you dislike on will appear here.',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 13,
                height: 1.4,
