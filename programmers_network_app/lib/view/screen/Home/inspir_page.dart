...
import 'package:programmers_network_app/view/widget/Home/inspir_chip.dart';
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: const OnboardingWidget(currentStep: 2)),
                            ...
                            children: [
                              ...
                              if (ctrl.isLoading)
                                ...
                                Builder(
                                  builder: (_) {
                                    final inspirations =
                                        ctrl.onboardingModel?.data.inspir ?? [];
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return InspirationChip(
                                          inspiration: inspiration,
                                          isSelected: _selectedIds.contains(
                                            inspiration.id,
                                          ),
                                          onTap: () => _toggle(inspiration.id),
                                        );
                                      },
                                    );
                                  },
