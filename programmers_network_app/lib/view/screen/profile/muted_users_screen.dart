...
import '../../../data/services/profile/MutedUsersService.dart'; // عدل المسار حسب مشروعك
  ...
  Widget _buildMutedTab(BuildContext context, Color primaryGreen) {
    return BlocConsumer<MutedUsersCubit, MutedUsersState>(
      ...
      builder: (context, state) {
        if (state is MutedUsersLoading && context.read<MutedUsersCubit>().currentMutedUsers.isEmpty) {
          return Center(
      ...
      children: [
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      ...
                      context.read<MutedUsersCubit>().fetchMutedHistory(type: 'sent');
                    },
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.arrow_upward_outlined,
                              size: 18, color: isSentType ? primaryGreen : Colors.grey),
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      ...
                      context.read<MutedUsersCubit>().fetchMutedHistory(type: 'received');
                    },
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 10),
                      decoration: BoxDecoration(
        ...
        Expanded(
          child: BlocBuilder<MutedUsersCubit, MutedUsersState>(
            builder: (context, state) {
              if (state is MutedUsersLoading && context.read<MutedUsersCubit>().historyList.isEmpty) {
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(
                            ...
                            color: isMuteAction ? Colors.redAccent : primaryGreen,
                            size: 18,
                          ),
                        ),
                        const SizedBox(width: 12),
