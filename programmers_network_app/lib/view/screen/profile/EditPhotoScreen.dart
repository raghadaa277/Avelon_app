...
class EditPhotoScreen extends StatefulWidget {
  ...
  const EditPhotoScreen({Key? key, required this.profileData})
    : super(key: key);
      ...
      body: BlocConsumer<ProfileCubit, ProfileState>(
        listener: (context, state) {
          if (state is AvatarUploadSuccess) {
            showSnackbar(title: "update image", message: state.message);
          } else if (state is AvatarRemoveSuccess) {
            setState(() {
              _imageFile = null;
            });
            showSnackbar(title: "remove image", message: state.message);
        ...
        builder: (context, state) {
          final isProcessing =
              state is AvatarUploading || state is AvatarRemoving;
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: _imageFile != null
                            ...
                            : (widget.profileData.avatarFullUrl != null
                                      ? NetworkImage(
                                          widget.profileData.avatarFullUrl!,
                                        )
                                      : null)
                                  as ImageProvider?,
                        child:
